...
class Tableau1 extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image('bg1-tree-3', 'assets/level/background-1/bg1-tree-3.png');
        this.load.image('bg1-tree-1', 'assets/level/background-1/bg1-tree-1.png');
    ...
    create(){
        ...
        let tree2=this.add.image(65,300, 'gTree2').setOrigin(0,1);
       // tree2.setTintFill(0xFF0000); // pratique pour dbugger
        this.groundContainer.add(tree2);
        tree2.scale=0.7;

        let tree3=this.add.image(252,300, 'gTree2').setOrigin(0,1);
         ...
         * @type {Phaser.GameObjects.Image}
         */
        let gMid4=this.add.image(gwater.x+gwater.width-40,350, 'gLeft').setOrigin(0,0);
