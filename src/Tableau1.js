...
class Tableau1 extends Phaser.Scene{
    ...
    create(){
       ...
       // let bgtree3=this.add.image(242,350, 'bg-tree-3').setOrigin(0,1);
         ...
         * @type {Phaser.GameObjects.Image}
         */
        let bg1Tree1=this.add.image(bg1Terrain1.x+bg1Terrain1.width,50, 'bg1-tree-3').setOrigin(0,0);
        this.bg1Container.add(bg1Tree1);
        let bg1Tree2=this.add.image(bg1Terrain4.x+bg1Terrain4.width,50, 'bg1-tree-1').setOrigin(0,0);
       ...
       // tree2.setTintFill(0xFF0000); // pratique pour dbugger
        ...
        this.cameras.main.setBounds(0, 0, 1950, 540);
